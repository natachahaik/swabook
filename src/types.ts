export class GoogleResponseProxy {
    ...
    public static Create(d: any, field: string = 'root'): VolumeInfoProxy {
      ...
      if (d.industryIdentifiers) {
        for (let i = 0; i < d.industryIdentifiers.length; i++) {
          d.industryIdentifiers[i] = IndustryIdentifiersEntityProxy.Create(d.industryIdentifiers[i], field + ".industryIdentifiers" + "[" + i + "]");
        }
      }
      if (d.industryIdentifiers === undefined) {
        d.industryIdentifiers = null;
      }
      d.readingModes = ReadingModesProxy.Create(d.readingModes, field + ".readingModes");
      ...
      if (d.categories) {
        for (let i = 0; i < d.categories.length; i++) {
          checkString(d.categories[i], false, field + ".categories" + "[" + i + "]");
        }
      }
      ...
      d.panelizationSummary = PanelizationSummaryProxy.Create(d.panelizationSummary, field + ".panelizationSummary");
  ...
  export class IndustryIdentifiersEntityProxy {
    ...
    public static Create(d: any, field: string = 'root'): IndustryIdentifiersEntityProxy {
      if (!field) {
        obj = d;
        field = "root";
      }
  ...
  export class PanelizationSummaryProxy {
    ...
    public static Create(d: any, field: string = 'root'): PanelizationSummaryProxy | null {
      if (!field) {
        obj = d;
        field = "root";
      }
      ...
      checkBoolean(d.containsImageBubbles, false, field + ".containsImageBubbles");
  ...
  export class SaleInfoProxy {
    ...
    public static Create(d: any, field: string = 'root'): SaleInfoProxy {
      ...
      d.listPrice = ListPriceOrRetailPriceProxy.Create(d.listPrice, field + ".listPrice");
      if (d.listPrice === undefined) {
        d.listPrice = null;
      }
      d.retailPrice = ListPriceOrRetailPrice1Proxy.Create(d.retailPrice, field + ".retailPrice");
      ...
      if (d.offers) {
        for (let i = 0; i < d.offers.length; i++) {
          d.offers[i] = OffersEntityProxy.Create(d.offers[i], field + ".offers" + "[" + i + "]");
        }
      }
  ...
  export class ListPriceOrRetailPriceProxy {
    ...
    public static Create(d: any, field: string = 'root'): ListPriceOrRetailPriceProxy | null {
      if (!field) {
        obj = d;
        field = "root";
      }
  ...
  export class ListPriceOrRetailPrice1Proxy {
    ...
    public static Create(d: any, field: string = 'root'): ListPriceOrRetailPrice1Proxy | null {
      if (!field) {
        obj = d;
        field = "root";
      }
  ...
  export class OffersEntityProxy {
    ...
    public static Create(d: any, field: string = 'root'): OffersEntityProxy {
      ...
      d.listPrice = ListPriceOrRetailPrice2Proxy.Create(d.listPrice, field + ".listPrice");
      d.retailPrice = ListPriceOrRetailPrice2Proxy.Create(d.retailPrice, field + ".retailPrice");
  ...
  export class ListPriceOrRetailPrice2Proxy {
    ...
    public static Create(d: any, field: string = 'root'): ListPriceOrRetailPrice2Proxy {
      if (!field) {
        obj = d;
        field = "root";
      }
  ...
  export class AccessInfoProxy {
    ...
    public static Create(d: any, field: string = 'root'): AccessInfoProxy {
      ...
      checkString(d.textToSpeechPermission, false, field + ".textToSpeechPermission");
